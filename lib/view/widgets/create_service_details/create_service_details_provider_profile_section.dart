      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Obx(() {
              final serviceDetails = controller.createServiceDetailsData.value;
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        ...
                                        TextSpan(text: " "),
                                        TextSpan(
                                          text: "(${serviceDetails.user?.totalReview ?? "0"})",
                                          style: TextStyle(
                                            fontSize: 10.sp,
                        ...
                        child: OutlinedButton(
                          onPressed: () {
                            controller.goToChatsRoomScreen(
                              username: serviceDetails.user?.name ?? "",
                              conversationId: "",
                              userId: serviceDetails.user?.id ?? "",
                            );
                          },
