...
class ServiceRequestDetailsBidComparisonSection extends GetWidget<ServiceRequestDetailsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final isMultipleBids = (bids?.length ?? 0) > 1;
      final bidText = isMultipleBids ? "Bids" : "Bid";
      return Container(
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: _buildBidBox(
                    label: "Average Bid",
                    value: HelperFunction.calculateAverageBidPrice(bids),
                ...
                Expanded(
                  child: _buildBidBox(
                    label: "Lowest Bid",
                    value: HelperFunction.calculateLowestBidPrice(bids),
